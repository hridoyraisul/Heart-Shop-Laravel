...
class FrontendController extends Controller
{
    public function index()
    {
        ...
        $latestProduct = Product::where('publication_status',1)->orderBy('id','DESC')->take(8)->get();
        $allProduct = Product::where('publication_status',1)->orderBy('id','DESC')->get();
    ...
    public function productDetails($request){
        ...
        $relatedProduct = Product::where('product_category',$product->product_category)->where('publication_status',1)->orderBy('id','DESC')->get();
        $latestProduct = Product::where('publication_status',1)->orderBy('id','DESC')->take(8)->get();
    ...
    public function categoryView($request){
        $allProduct = Product::where('product_category',$request)->where('publication_status',1)->orderBy('id','DESC')->paginate(9);
        return view('frontend.shop_view',compact('allProduct'));
    }

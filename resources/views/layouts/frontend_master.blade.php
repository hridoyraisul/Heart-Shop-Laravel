                        ...
                        <ul>
                            ...
                            <li><a href="#">Category <i class="fas fa-angle-down"></i></a>
                                <ul class="submenu">
                                    ...
                                    <li><a href="#">Sandal & Shoe</a>
                                        <ul class="submenu">
                                            <a href="#">Coming soon</a>
                                        </ul>
                                    </li>
                                    <li><a href="#">Smart Gadgets</a>
                                        <ul class="submenu">
                                            <a href="#">Coming soon</a>
                                        </ul>
                                    </li>
                                    <li><a href="#">Gifts & Show-pices</a>
                                        <ul class="submenu">
                                            <a href="#">Coming soon</a>
                                        </ul>
                                    </li>
                            ...
                            <li><a href="#">Videos</a>
                                <div class="mega-menu">
                                    ...
                                    <ul>
                                        <li class="mega-title"><a href="#">Grooming Tips</a></li>
                                        <li><a href="{{url('/video/play')}}">play video page demo</a></li>
                                        <li><a href="#">Mega menu Item</a></li>
                                        <li><a href="#">Mega menu Item</a></li>
                                        <li><a href="#">Mega menu Item</a></li>
                                    </ul>
                                    <ul>
                                        <li class="mega-title"><a href="#">Healt Tips</a></li>
                                        <li><a href="#">Mega menu Item</a></li>
                                        <li><a href="#">Mega menu Item</a></li>
                                        <li><a href="#">Mega menu Item</a></li>
                                        <li><a href="#">Mega menu Item</a></li>
                            ...
                            <li class="position-static"><a href="#">Items</a>
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-sm-4 ">
                    <div class="footer-icon d-flex justify-content-end align-items-center">
                        ...
                        <a href="https://www.facebook.com/exheartz"><i class="fab fa-facebook-f"></i></a>
                        <a href="https://www.twitter.com/raisul_hridoy"><i class="fab fa-twitter"></i></a>
                        <a href="https://www.instagram.com/raisulhridoy"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </div>
